...
\bulletlist{Programming languages}{
    \bitem {Groovy} {3}{Worked on Pipeliner}
...
\bulletlist{Operating systems}{
    \bitem {Desktop/server Linuxes} {1}{Arch user. Used Linux for more than a decade}
...
\bulletlist{Tools, Frameworks \& Tech} {
    ...
    \bitem {Jenkins}        {3}{Used extended and configured professionally for contiguous integration}
    ...
    \bitem {Ruby on Rails}  {1}{Build many big web systems}
    \bitem {Node JS}        {2}{Used it for several bigger systems}
    \bitem {UIKit}          {1}{Written many iOS applications}
}
